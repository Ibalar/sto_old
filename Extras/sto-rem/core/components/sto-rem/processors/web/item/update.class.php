...
class sto-remOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('sto-rem_item_err_ns');
        }
...
return 'sto-remOfficeItemUpdateProcessor';

sto-rem.grid.Default = function (config) {
    config = config || {};
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {},
        cls: config['cls'] || 'main-wrapper sto-rem-grid',
        autoHeight: true,
        paging: true,
        remoteSort: true,
        ...
        viewConfig: {
            ...
            getRowClass: function (rec) {
                ...
                if (rec.data['published'] != undefined && rec.data['published'] == 0) {
                    cls.push('sto-rem-row-unpublished');
                }
                if (rec.data['active'] != undefined && rec.data['active'] == 0) {
                    cls.push('sto-rem-row-inactive');
                }
                if (rec.data['deleted'] != undefined && rec.data['deleted'] == 1) {
                    cls.push('sto-rem-row-deleted');
                }
                if (rec.data['required'] != undefined && rec.data['required'] == 1) {
                    cls.push('sto-rem-row-required');
                }
                return cls.join(' ');
            }
        },
    });
    sto-rem.grid.Default.superclass.constructor.call(this, config);
...
Ext.extend(sto-rem.grid.Default, MODx.grid.Grid, {
    ...
    getMenu: function (grid, rowIndex) {
        ...
        var menu = sto-rem.utils.getMenu(row.data['actions'], this, ids);
...
Ext.reg('sto-rem-grid-default', sto-rem.grid.Default);

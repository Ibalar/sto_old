...
$(document).ready( function() {
    $('.header__burger').click(function (event) {
        $('.header__burger,.header-block__menu').toggleClass('active');
        $('body').toggleClass('lock');
    });
    $('.menu__link').click(function (event) {
        $('.header__burger,.header-block__menu').removeClass('active');
...
function init () {
    ...
    var myMap = new ymaps.Map('map', {
        ...
        center: [53.821151, 27.576729], // Минск
        zoom: 16
    });
    // Создание метки 

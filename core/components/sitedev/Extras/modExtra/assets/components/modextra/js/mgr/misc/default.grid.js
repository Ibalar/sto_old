modExtra.grid.Default = function (config) {
    config = config || {};
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {},
        cls: config['cls'] || 'main-wrapper modextra-grid',
        autoHeight: true,
        paging: true,
        remoteSort: true,
    ...
    modExtra.grid.Default.superclass.constructor.call(this, config);
...
Ext.extend(modExtra.grid.Default, MODx.grid.Grid, {
...
Ext.reg('modextra-grid-default', modExtra.grid.Default);
